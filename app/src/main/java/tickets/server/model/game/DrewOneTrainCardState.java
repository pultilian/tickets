...
public class DrewOneTrainCardState extends PlayerTurnState {
    private String drewOneTrainCardStateFlag = "flag";

    // Singleton pattern
    private static DrewOneTrainCardState INSTANCE;

    public static DrewOneTrainCardState getInstance() {
        if (INSTANCE == null) {
